...
#' wb:
#'  input:
#'  - summaries: '`sm expand(config["htmlOutputPath"] + "/Outrider/{annotation}/Summary_{dataset}.html", annotation=config["GENE_ANNOTATION"].keys() , dataset=parser.outrider_filtered)`'
#' output:
#'   html_document:
#'    code_folding: hide
#'    code_download: TRUE
