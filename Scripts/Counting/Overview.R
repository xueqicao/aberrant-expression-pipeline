...
#' wb:
#'  input: 
#'  - summaries: '`sm expand(config["htmlOutputPath"] + "/Counting/{annotation}/Summary_{dataset}.html", annotation=list(config["GENE_ANNOTATION"].keys()), dataset=parser.outrider_filtered)`'
#' output:
#'   html_document:
#'    code_folding: hide
#'    code_download: TRUE
